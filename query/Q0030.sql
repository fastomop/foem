-- How many people were treated by drug {drug_name} more than 30 days after being diagnosed with condition {condition_name}?
...
pairs AS (
    ...
    INNER JOIN drug_exposure de
       ...
       AND (de.drug_exposure_start_date - co.condition_start_date) > 30

...
WITH
    ...
    overlapping_triples AS (
        SELECT DISTINCT a.person_id,
            GREATEST(a.start_date, b.start_date, c.start_date) AS overlap_start,
            LEAST(a.start_date, b.start_date, c.start_date) AS overlap_end
        ...
        WHERE (GREATEST(a.start_date, b.start_date, c.start_date) - 
               LEAST(a.start_date, b.start_date, c.start_date)) <= %(days)s::int
    )
SELECT COUNT(DISTINCT person_id)
FROM overlapping_triples;